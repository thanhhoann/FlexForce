    ...
    return (
        <Box w='80%' h='90vh'>
            <Flex h='full' w='full' gap='6rem'>
                <Box align='center' bg='light.primary' minHeight='full' minWidth='50%' color='black' clipPath='polygon(0 0, 100% 0, 70% 100%, 0 100%)' marginRight='-7rem' rounded='0.5rem'>
                ...
                <Box align='center' bg='dark.primary' minHeight='full' minWidth='50%' color='white' clipPath='polygon(30% 0, 100% 0, 100% 100%, 0 100%)' marginLeft='-7rem' rounded='0.5rem'>
